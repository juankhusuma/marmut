...
export default async function AlbumLabelDetails({ params }: { params: { id: string } }) {
            ...
            <div className="w-auto">
                <div className="bg-white shadow overflow-hidden rounded-lg">
                    ...
                    <div className="border-t border-gray-200">
                        {songs.length === 0 ? (
                            <div className="p-4 text-center text-gray-500">This album has no songs :(</div>
                        ) : (
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-deep-blue">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-4 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Durasi</th>
                                        <th scope="col" className="px-4 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Total Play</th>
                                        <th scope="col" className="px-4 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Total Download</th>
